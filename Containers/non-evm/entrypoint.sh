...
start_xray_daemon() {
    ...
    if [ $? -eq 0 ]; then
        ...
        log_with_timestamp "⚠️ X-Ray daemon not found in PATH at: $PATH" "xray"
    fi
}
...
# Keep all the remaining functions and logic as they were
...
EOF
            ...
            # Run tests and the rest of the processing...
